...
- [dcode](https://docs.langchain.com/oss/category/deep-agents-code) — Open-source terminal coding agent by LangChain. Model-agnostic with persistent memory and sandboxing.
