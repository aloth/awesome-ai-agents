...
- [Model Cowork](https://github.com/Thatweirdguy1/Models-Cowork) — Dependency-free coordination kit for AI coding across Codex, Claude Code, GitHub Copilot, Antigravity, and Ollama; routes work, protects file ownership, and produces portable handoffs.
