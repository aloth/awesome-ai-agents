...
- [OpenAgentFlow](https://github.com/OpenAgentFlow/openagentflow) — Open-source specification language (`.oaf`) and compiler for defining portable multi-agent workflows. Compiles directly to LangGraph Python applications.
